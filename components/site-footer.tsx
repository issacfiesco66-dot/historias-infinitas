    ...
    <footer className="mt-24 border-t border-pizarra-100/70 bg-pizarra-700 text-marfil">
      <div className="container-solemn py-12 grid gap-10 md:grid-cols-3">
        ...
        <div className="text-sm space-y-2">
          ...
          <Link className="block hover:text-dorado-300" href="/#mascotas">Memoriales de Mascotas</Link>
          <Link className="block hover:text-dorado-300" href="/#seres-queridos">Memoriales de Seres Queridos</Link>
      ...
      <div className="border-t border-marfil/10 py-6 text-center text-xs text-marfil/50">
        © {new Date().getFullYear()} Historias Infinitas · Hecho con cuidado
      </div>
    </footer>
  );
}
